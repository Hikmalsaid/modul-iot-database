...
void loop() {
  ...
  Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/string"), "Terdeteksi gas") ? "ok" : fbdo.errorReason().c_str());

  delay(1000);
  }
  else {

  Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/string"), "Tidak terdeteksi gas") ? "ok" : fbdo.errorReason().c_str());

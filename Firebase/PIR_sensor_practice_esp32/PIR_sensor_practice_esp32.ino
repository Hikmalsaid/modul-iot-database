...
void loop() {
   ...
   if (Firebase.ready() && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0))
  {
    ...
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/deteksi_gerakan"), "Terdeteksi gerakan") ? "ok" : fbdo.errorReason().c_str());

    Serial.printf("Get string... %s\n", Firebase.getString(fbdo, F("/test/deteksi_gerakan")) ? fbdo.to<const char *>() : fbdo.errorReason().c_str());
    ...
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/deteksi_gerakan"), "Tidak terdeteksi gerakan") ? "ok" : fbdo.errorReason().c_str());

...
void loop() {
  ...
  if(red > 150 && green > 250 && blue > 300)
  {
    ...
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/warna"), "Hijau") ? "ok" : fbdo.errorReason().c_str());

    Serial.printf("Get string... %s\n", Firebase.getString(fbdo, F("/test/warna")) ? fbdo.to<const char *>() : fbdo.errorReason().c_str());

  }  
  if(red < 200 && green > 250 && blue > 230)
  {
    
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/warna"), "Merah") ? "ok" : fbdo.errorReason().c_str());
  ...
  if(red < 250 && green > 250 && blue < 250)
  {
    ...
    Serial.printf("Set string... %s\n", Firebase.setString(fbdo, F("/test/warna"), "Biru") ? "ok" : fbdo.errorReason().c_str());
